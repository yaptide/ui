...
return new Promise((loadDataResolve, loadDataReject) => {
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/workspaces/geant-wasm/build_wasm/data/G4SAIDDATA2.0.data';
      var REMOTE_PACKAGE_BASE = 'G4SAIDDATA2.0.data';
      ...
      async function fetchRemotePackage(packageName, packageSize) {
        ...
        while (1) {
          ...
          Module['setStatus']?.(`DL (G4SAIDDATA) (${totalLoaded}/${totalSize})`);
        }
        Module['setStatus']?.(`END DL (G4SAIDDATA)`);
...
loadDataResolve();
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/workspaces/geant-wasm/build_wasm/data/G4SAIDDATA2.0.data');

      }
      Module['addRunDependency']('datafile_/workspaces/geant-wasm/build_wasm/data/G4SAIDDATA2.0.data');
    ...
    Module['removeRunDependency']('preload_G4SAIDDATA2.0.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('preload_G4SAIDDATA2.0.js.metadata');
    var metadataUrl = Module['locateFile']?.('preload_G4SAIDDATA2.0.js.metadata', '') ?? 'preload_G4SAIDDATA2.0.js.metadata';
