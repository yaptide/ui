...
return new Promise((loadDataResolve, loadDataReject) => {
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/workspaces/geant-wasm/build_wasm/data/PhotonEvaporation6.1.data';
      var REMOTE_PACKAGE_BASE = 'PhotonEvaporation6.1.data';
      ...
      async function fetchRemotePackage(packageName, packageSize) {
        ...
        while (1) {
          ...
          Module['setStatus']?.(`DL (PhotonEvaporation) (${totalLoaded}/${totalSize})`);
        }
        Module['setStatus']?.(`END DL (PhotonEvaporation)`);
...
loadDataResolve();
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/workspaces/geant-wasm/build_wasm/data/PhotonEvaporation6.1.data');

      }
      Module['addRunDependency']('datafile_/workspaces/geant-wasm/build_wasm/data/PhotonEvaporation6.1.data');
    ...
    Module['removeRunDependency']('preload_PhotonEvaporation6.1.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('preload_PhotonEvaporation6.1.js.metadata');
    var metadataUrl = Module['locateFile']?.('preload_PhotonEvaporation6.1.js.metadata', '') ?? 'preload_PhotonEvaporation6.1.js.metadata';
