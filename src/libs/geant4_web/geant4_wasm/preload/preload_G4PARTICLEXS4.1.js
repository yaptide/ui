...
return new Promise((loadDataResolve, loadDataReject) => {
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/workspaces/geant-wasm/build_wasm/data/G4PARTICLEXS4.1.data';
      var REMOTE_PACKAGE_BASE = 'G4PARTICLEXS4.1.data';
      ...
      async function fetchRemotePackage(packageName, packageSize) {
        ...
        while (1) {
          ...
          Module['setStatus']?.(`DL (G4PARTICLEXS) (${totalLoaded}/${totalSize})`);
        }
        Module['setStatus']?.(`END DL (G4PARTICLEXS)`);
...
Module['FS_createPath']("/data/G4PARTICLEXS4.1", "He3", true, true);
Module['FS_createPath']("/data/G4PARTICLEXS4.1", "alpha", true, true);
Module['FS_createPath']("/data/G4PARTICLEXS4.1", "deuteron", true, true);
Module['FS_createPath']("/data/G4PARTICLEXS4.1", "gamma", true, true);
Module['FS_createPath']("/data/G4PARTICLEXS4.1", "neutrino", true, true);
Module['FS_createPath']("/data/G4PARTICLEXS4.1/neutrino", "nu_mu", true, true);
Module['FS_createPath']("/data/G4PARTICLEXS4.1", "neutron", true, true);
Module['FS_createPath']("/data/G4PARTICLEXS4.1", "proton", true, true);
Module['FS_createPath']("/data/G4PARTICLEXS4.1", "triton", true, true);
...
loadDataResolve();
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/workspaces/geant-wasm/build_wasm/data/G4PARTICLEXS4.1.data');

      }
      Module['addRunDependency']('datafile_/workspaces/geant-wasm/build_wasm/data/G4PARTICLEXS4.1.data');
    ...
    Module['removeRunDependency']('preload_G4PARTICLEXS4.1.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('preload_G4PARTICLEXS4.1.js.metadata');
    var metadataUrl = Module['locateFile']?.('preload_G4PARTICLEXS4.1.js.metadata', '') ?? 'preload_G4PARTICLEXS4.1.js.metadata';
