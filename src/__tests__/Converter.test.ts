...
describe('NavDrawer component', () => {
  ...
  test('converter generates correct files', async () => {
    ...
    const openProjectWidget = await driver.wait(until.elementLocated(By.css(".MuiPaper-elevation24")), 10000);
    ...
    const firstExample = await openProjectWidget.findElement(By.css("li.MuiListItem-root:nth-child(1) > div:nth-child(1)"));
    ...
    const geoText = (await driver.findElement(By.css('.MuiCardContent-root > div:nth-child(2) > div:nth-child(2) > textarea:nth-child(1)')).getText()).replace(regex, '');
    ...
    const matText = (await driver.findElement(By.css('.MuiCardContent-root > div:nth-child(3) > div:nth-child(2) > textarea:nth-child(1)')).getText()).replace(regex, '');
    ...
    const beamText = (await driver.findElement(By.css('.MuiCardContent-root > div:nth-child(4) > div:nth-child(2) > textarea:nth-child(1)')).getText()).replace(regex, '');
    ...
    const detectText = (await driver.findElement(By.css('.MuiCardContent-root > div:nth-child(5) > div:nth-child(2) > textarea:nth-child(1)')).getText()).replace(regex, '');
