...
describe('NavDrawer component', () => {
  ...
  test('converter generates correct files', async () => {
    ...
    const editorButton = await driver.findElement(By.xpath("//div[@aria-labelledby = 'Editor']"));
    ...
    const openProjectWidget = await driver.wait(until.elementLocated(By.xpath("//div[@aria-label = 'Open project dialog']")), 10000);
    ...
    const loadButton = await openProjectWidget.findElement(By.xpath("//button[@aria-labelledby = 'Load example button']"));
    ...
    const filesButton = await driver.findElement(By.xpath("//div[@aria-labelledby = 'Input files']"));
    ...
    await driver.wait(until.elementTextMatches(driver.findElement(By.xpath("//textarea[@aria-label = 'geo.dat text field']")), /\S/));
