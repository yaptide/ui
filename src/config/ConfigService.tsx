...
const DEMO_MODE = import.meta.env.VITE_REACT_APP_TARGET === 'demo';
const ALT_AUTH = import.meta.env.VITE_REACT_APP_ALT_AUTH === 'plg';

export const DEPLOYMENT = (import.meta.env.VITE_REACT_APP_DEPLOYMENT as ConfigDeployment) ?? 'prod';
