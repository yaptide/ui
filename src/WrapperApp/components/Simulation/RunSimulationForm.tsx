...
export function RunSimulationForm({
    ...
    const [simulationRunType, setSimulationRunType] =
        useState<SimulationRunType>("direct");
    ...
    const handleRunSimulationClick = () => {
        const filteredInputFiles = Object.entries(inputFiles).reduce(
            (acc, [key, value]) => {
            ...
            <TabPanel value={tabValue} index={0}>
                ...
                >
                    ...
                    <TextField
                        ...
                        value={nTasks}
                        onChange={(e) =>
                            setNTasks(Math.max(1, parseInt(e.target.value)))
                        }
                    />
                    <TextField
                        size="small"
