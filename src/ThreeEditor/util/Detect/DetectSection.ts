		...
		switch (type) {
			case 'Mesh':
				geometry = new THREE.BoxGeometry(
					...
					data.height,
					data.depth,
					Math.min(data.widthSegments, DetectSection.maxDisplayDensity),
					Math.min(data.heightSegments, DetectSection.maxDisplayDensity),
...
export const isDetectSection = (x: any): x is DetectSection => x instanceof DetectSection;
