...
function Toolbar(editor) {
	...
	translateIcon.src = process.env.PUBLIC_URL + '/images/translate.svg';
	...
	rotateIcon.src = process.env.PUBLIC_URL + '/images/rotate.svg';
	...
	scaleIcon.src = process.env.PUBLIC_URL + '/images/scale.svg';
